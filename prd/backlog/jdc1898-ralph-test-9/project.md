...
- [ ] Create `resources/views/livewire/activity-log.blade.php` with a "Recent Activity" heading, listing all 10 entries styled by type using Flux UI components and Tailwind CSS (green for login, blue for update, red for delete)
